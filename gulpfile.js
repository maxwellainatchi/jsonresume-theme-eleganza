const { src, dest, watch, series, once } = require("gulp");
...
function fontawesome() {
  return src("./node_modules/@fortawesome/fontawesome-free/**/*").pipe(
    dest("./public/fontawesome")
  );
}
...
exports.css = css;
exports.default = series(fontawesome, css, html, serve);
